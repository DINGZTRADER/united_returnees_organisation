...
export default async function Admin() {
  ...
  const [registered, activeMembers, planning, returned, openSupport, approvedAwaitingPayment, applications, briefingItems, knowledgeArticles, conciergeQuestions] = await Promise.all([
    ...
    <section className="section dashboard-page admin-page">
      <div className="container">
        <div className="dash-head">
          <div><span className="eyebrow">URO Administration</span><h1>Returnee intelligence dashboard</h1><p>Signed in as {profile.full_name}. Manage applications, public briefings, visitor demand signals, verified concierge knowledge and operational support from one place.</p></div>
